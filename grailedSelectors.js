...
exports.CATEGORIES = {
    ...
    bottoms: {
        ...
        denim : ".categories-wrapper .bottoms-wrapper > p.active-indicator:nth-of-type(3)",
        leggings : ".categories-wrapper .bottoms-wrapper > p.active-indicator:nth-of-type(4)",
        jumpsuits : ".categories-wrapper .bottoms-wrapper > p.active-indicator:nth-of-type(5)",
        shorts : ".categories-wrapper .bottoms-wrapper > p.active-indicator:nth-of-type(6)",
        sweatpants : ".categories-wrapper .bottoms-wrapper > p.active-indicator:nth-of-type(7)",
    ...
    outerwear: {
        ...
        denim : ".categories-wrapper .outerwear-wrapper > p.active-indicator:nth-of-type(3)",
        heavy : ".categories-wrapper .outerwear-wrapper > p.active-indicator:nth-of-type(4)",
        leather : ".categories-wrapper .outerwear-wrapper > p.active-indicator:nth-of-type(5)",
        light : ".categories-wrapper .outerwear-wrapper > p.active-indicator:nth-of-type(6)",
        parkas : ".categories-wrapper .outerwear-wrapper > p.active-indicator:nth-of-type(7)",
        raincoats : ".categories-wrapper .outerwear-wrapper > p.active-indicator:nth-of-type(8)",
    ...
    footwear: {
        ...
        formal : ".categories-wrapper .footwear-wrapper > p.active-indicator:nth-of-type(3)",
        hitop : ".categories-wrapper .footwear-wrapper > p.active-indicator:nth-of-type(4)",
        lotop : ".categories-wrapper .footwear-wrapper > p.active-indicator:nth-of-type(5)",
        sandals : ".categories-wrapper .footwear-wrapper > p.active-indicator:nth-of-type(6)",
    ...
    tailoring: {
        ...
        formalTrousers : ".categories-wrapper .tailoring-wrapper > p.active-indicator:nth-of-type(3)",
        suits : ".categories-wrapper .tailoring-wrapper > p.active-indicator:nth-of-type(4)",
        tuxedos : ".categories-wrapper .tailoring-wrapper > p.active-indicator:nth-of-type(5)",
    ...
    accessories: {
        ...
        glasses : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(3)",
        glovesAndScarves : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(4)",
        hats : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(5)",
        jeweleryAndWatches : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(6)",
        wallets : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(7)",
        misc : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(8)",
        periodicals : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(9)",
        socksAndUnderwear : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(10)",
        sunglasses : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(11)",
        supreme : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(12)",
        tiesAndPocketSquares : ".categories-wrapper .accessories-wrapper > p.active-indicator:nth-of-type(13)"
    }
}
...
exports.SIZES = {
    tops: {
        ...
        M : ".sizes-wrapper .sizes.tops.outerwear > p.active-indicator:nth-of-type(4)",
        L : ".sizes-wrapper .sizes.tops.outerwear > p.active-indicator:nth-of-type(5)",
        XL : ".sizes-wrapper .sizes.tops.outerwear > p.active-indicator:nth-of-type(6)",
    ...
    footwear: {
        ...
        "9.5" : ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(10)",
        "10" : ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(11)",
        "10.5" : ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(12)",
        "11" : ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(13)",
        "11.5" : ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(14)",
        "12" : ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(15)",
        "12.5" : ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(16)",
    ...
    tailoring: {
        ...
        "36R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(4)",
        "38S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(5)",
        "38R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(6)",
        "38L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(7)",
        "40S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(8)",
        "40R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(9)",
        "40L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(10)",
        "42S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(11)",
        "42R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(12)",
        "42L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(13)",
        "44S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(14)",
        "44R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(15)",
        "44L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(16)",
        "46S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(17)",
        "46R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(18)",
        "46L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(19)",
        "48S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(20)",
        "48R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(21)",
        "48L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(22)",
        "50S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(23)",
        "50R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(24)",
        "50L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(25)",
        "52S" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(26)",
        "52R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(27)",
        "52L" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(28)",
        "54R" : ".sizes-wrapper .sizes.tailoring > p.active-indicator:nth-of-type(29)",

exports.GrailedSelectors = function() {
  ...
  self.SIZES = {
    ...
    footwear: {
      ...
      "6.5":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(4)",
      "7": ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(5)",
      "7.5":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(6)",
      "8": ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(7)",
      "8.5":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(8)",
      ...
      "10":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(11)",
      "10.5":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(12)",
      "11":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(13)",
      "11.5":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(14)",
      "12":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(15)",
      "12.5":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(16)",
      "13":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(17)",
      "14":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(18)",
      "15":
        ".sizes-wrapper .sizes.footwear > p.active-indicator:nth-of-type(19)"
    },
    tailoring: {
      panel:
